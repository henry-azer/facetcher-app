...
class UserSubmissionRepositoryImpl implements UserSubmissionRepository {
  ...
  @override
  Future<Either<GenericException, ResponseModel<UserSubmission>>>
      createOrUpdateUserSubmission(
          UserSubmissionRequest userSubmissionRequest) async {
    if (await networkInfo.isConnected) {
      try {
        final responseUserSubmission = await userSubmissionRemoteDataSource
            .createOrUpdateUserSubmission(userSubmissionRequest);
